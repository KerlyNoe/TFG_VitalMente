...
if (isset($_POST['nombre'], $_POST['primer_apellido'], $_POST['segundo_apellido'], $_POST['mail'], $_POST['password'], $_POST['telefono'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($resultado->num_rows > 0) {
            ...
            $query = "SELECT id_usuarios FROM usuarios WHERE telefono = ?";
            $stmt = $conn->prepare($query);
