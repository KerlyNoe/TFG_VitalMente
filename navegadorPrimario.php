...
<html lang="es">
    <head>
        ...
        <script src="bootstrap/js/bootstrap.bundle.min.js"></script> <!-- Usamos bundle para que incluya Popper -->
                            ...
                            <?php
                                if (isset($_SESSION['id_usuarios'])) {
                                    ...
                                    if ($tipo_usuario === 'administrador') {
                                        echo '<a href="insertar_actividades.php" class="btn btn-outline-secondary">Editar Eventos</a>';
                                    ...
                                    echo '<a href="servicios.php" class="btn btn-outline-secondary">Servicios</a>';
